...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderVO createOrder(ShopOrderBO shopOrderBO, List<ShopcartBO> shopcartBOList) {
        ...
        orderVO.setToBeRemoveShopCartBoList(toBeRemoveShopCartBoList);
